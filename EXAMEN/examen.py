...
# Inicializar
pygame.init()
pygame.mixer.music.load("gei.ogg")
...
# Carga imágenes
fondo = pygame.image.load("campo.jpg").convert()
nave_arr = pygame.image.load("download-removebg-preview.png").convert_alpha()
nave_abj = pygame.image.load("download-removebg-preview.png").convert_alpha()
nave_izq = pygame.image.load("download-removebg-preview.png").convert_alpha()
nave_der = pygame.image.load("download-removebg-preview.png").convert_alpha()

aste_1a = pygame.image.load("barca1.png").convert_alpha()
aste_1b = pygame.image.load("gavi10-removebg-preview.png").convert_alpha()
aste_1c = pygame.image.load("messi5-removebg-preview.png").convert_alpha()
aste_1d = pygame.image.load("pedri11-removebg-preview.png").convert_alpha()
...
aste_2a = pygame.image.load("messi4-removebg-preview.png").convert_alpha()
aste_2b = pygame.image.load("pique6-removebg-preview.png").convert_alpha()
aste_2c = pygame.image.load("iniesta7-removebg-preview.png").convert_alpha()
aste_2d = pygame.image.load("xavi8-removebg-preview.png").convert_alpha()
